...
public class Grammar implements GrammarConstants {
  ...
  static final public void relation_operator() throws ParseException {
    if (jj_2_26(2)) {
      jj_consume_token(LESS_OP);
    } else if (jj_2_27(2)) {
      jj_consume_token(MORE_OP);
    } else if (jj_2_28(2)) {
      jj_consume_token(33);
    } else if (jj_2_29(2)) {
      jj_consume_token(34);
  ...
  static final public void mul_operator() throws ParseException {
    if (jj_2_30(2)) {
  ...
  static final public void add_operator() throws ParseException {
    if (jj_2_33(2)) {
