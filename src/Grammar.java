...
public class Grammar implements GrammarConstants {
  ...
  static final public void expression() throws ParseException {
    ...
    if (jj_2_12(2)) {
      x = jj_consume_token(ID);
                   IIG.expression1(model, x);
      jj_consume_token(EQUAL);
      expression();
                                                                 IIG.expression2(model);
    } else if (jj_2_13(2)) {
      condition();
    } else {
      jj_consume_token(-1);
  ...
  static final public String relation_operator() throws ParseException {
                             Token x;
    if (jj_2_26(2)) {
      x = jj_consume_token(LESS_OP);
  ...
  static final public String mul_operator() throws ParseException {
                        Token x;
    if (jj_2_30(2)) {
  ...
  static final public String add_operator() throws ParseException {
                        Token x;
    if (jj_2_33(2)) {
  ...
  static private boolean jj_3_27() {
    if (jj_scan_token(MORE_OP)) return true;
    return false;
  }
